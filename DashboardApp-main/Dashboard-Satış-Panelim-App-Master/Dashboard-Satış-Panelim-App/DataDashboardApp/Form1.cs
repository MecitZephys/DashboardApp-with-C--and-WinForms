...
namespace DashboardApp
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            //Default olarak son 7 günün satışlarını çekmeyi ayarlıyor
        ...
        private void lblStartDate_Click(object sender, EventArgs e)
        {
            ...
            {
                dtpStartDate.Select(); //Tarih seçme butonuna tasarım yapmak için label oluşturduk 
                SendKeys.Send("%{DOWN}");
            }
        }
        ...
        private void lblEndDate_Click(object sender, EventArgs e)
        {
            if (currentButton == btnCustomDate)
            {
                dtpEndDate.Select(); //Tarih seçme butonuna tasarım yapmak için label oluşturduk 
                SendKeys.Send("%{DOWN}");
            }
        }
        ...
        {
            lblStartDate.Text = dtpStartDate.Text;//tarih değerlerini çekip labela yansıtıyor
        }

        private void dtpEndDate_ValueChanged(object sender, EventArgs e)
        {
            lblEndDate.Text = dtpEndDate.Text; //tarih değerlerini çekip labela yansıtıyor
        }
